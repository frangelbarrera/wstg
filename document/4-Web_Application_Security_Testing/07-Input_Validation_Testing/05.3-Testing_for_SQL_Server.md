...
Alternativamente, uno puede tener suerte. Es decir, el atacante puede asumir que hay una vulnerabilidad de inyección SQL ciega o fuera de banda en la aplicación web. Él seleccionará entonces un vector de ataque (ej., una entrada web), [usará vectores de fuzz](../../6-Appendix/C-Fuzzing.md) contra este canal y observará la respuesta. Por ejemplo, si la aplicación web está buscando un libro usando una consulta
