...
Se puede aplicar el mismo enfoque visto en la sección [Prueba de funcionalidad de cierre de sesión](06-Testing_for_Logout_Functionality.md) al medir el cierre de sesión por tiempo de espera.
